...
import InvoiceToolbar from '../components/sales/InvoiceToolbar';
import CustomerEditModal from '../components/sales/CustomerEditModal';
import InvoiceActionDropdown from '../components/sales/InvoiceActionDropdown';
...
export default function Sales() {
  ...
  const invoices = [
    { id: 1, number: 'FEIP-0847', customer: 'Constructora Andina S.A.S', date: '3 de jun de 2026', due: '3 de jul de 2026', docStatus: 'borrador', dianStatus: 'Sin envío', total: 9996000, isActive: true, filterState: 'no-enviado' },
    { id: 2, number: 'FEIP-0846', customer: 'Inversiones Torres & Co.', date: '31 de may de 2026', due: '30 de jun de 2026', docStatus: 'emitida', dianStatus: 'Pendiente', total: 5400000, isActive: false, filterState: 'sin-dian' },
    { id: 3, number: 'FEIP-0845', customer: 'Alimentos y Bebidas del Valle', date: '28 de may de 2026', due: '28 de jun de 2026', docStatus: 'pagada', dianStatus: 'Aprobada', total: 1250000, isActive: false, filterState: 'todas' },
    { id: 4, number: 'FEIP-0844', customer: 'Textiles Medina S.A.', date: '25 de may de 2026', due: '25 de jun de 2026', docStatus: 'pagada', dianStatus: 'Aprobada', total: 8900000, isActive: false, filterState: 'todas' },
    { id: 5, number: 'FEIP-0840', customer: 'Distribuidora El Pino', date: '10 de abr de 2026', due: '10 de may de 2026', docStatus: 'emitida', dianStatus: 'Pendiente', total: 4200000, isActive: false, filterState: 'vencidas' }
  ];

  const filteredInvoices = invoiceFilter === 'todas'
    ? invoices
    : invoices.filter(inv => inv.filterState === invoiceFilter);

  const invoiceFilterOptions = [
    { id: 'todas', label: 'Todas', count: null },
    { id: 'pendiente_dian', label: 'Pendiente DIAN', count: 14, color: '#ef4444', bg: '#fee2e2' },
    { id: 'sin_envio', label: 'Sin envío', count: 9, color: '#d97706', bg: '#fef3c7' },
    { id: 'en_proceso', label: 'En proceso', count: 0, color: '#3b82f6', bg: '#eff6ff' },
    { id: 'vencidas', label: 'Vencidas', count: 4, color: '#ef4444', bg: '#fee2e2' }
  ];
